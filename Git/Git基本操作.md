...
此时文件就会标记冲突，由开发人员解决冲突后重新提交。

![image-20201031222613681](img/image-20201031222613681.png)

根据需要，修改代码并删除标记后重新推送和提交解决合并冲突

## 2.5 分支 TODO

几乎所有的版本控制系统都支持分支。 使用分支可以把工作从开发主线上分离出来进行重大的Bug修改、开发新的功能等，以免影响开发主线。
